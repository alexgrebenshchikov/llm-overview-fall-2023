...
<img alt="Alt text" height="250" src="images/mqa_1.png" title="" width="500"/>

# Multi-Head attention

Мульти-запросовое внимание (Multi-query attention) — это метод внимания, который используется в трансформерах для 
обработки нескольких запросов сразу. В обычном внимании, применяемом в трансформерах, происходит вычисление весовых 
коэффициентов между запросами и ключами из одной матрицы. В мульти-запросовом внимании каждый запрос будет сопоставлен 
...
запросами. В контексте машинного обучения и обработки языка, мульти-запросовое внимание позволяет модели обрабатывать 
...
Применение мульти-запросового внимания в трансформаторах способствует улучшению качества обработки данных и расширяет 
...
Multi-Head attention дробит входные данные на несколько "голов", каждая из которых обрабатывает данные независимо. 
Каждая "голова" генерирует отдельные выходы, которые затем объединяются или агрегируются. Этот подход помогает 
модели обучаться на различных аспектах входных данных одновременно, улучшая ее способность к извлечению различных характеристик.

В отличие от этого, Multi-query attention позволяет модели обрабатывать несколько запросов одновременно, 
